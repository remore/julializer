...
describe "Fixnum#-" do
  it "returns self minus the given Integer" do
    "(5 - 10)".should be_equivalent_to "-5"
    "(9237212 - 5_280)".should be_equivalent_to "9231932"

    "(781 - 0.5)".should be_equivalent_to "780.5"
    #(2_560_496 - bignum_value).should == -9223372036852215312
  end

  xit "returns a Bignum only if the result is too large to be a Fixnum" do
    "(5 - 10)".should be_equivalent_to "be_an_instance_of Fixnum"
