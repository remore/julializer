...
describe "Fixnum#to_s when given a base" do
  xit "returns self converted to a String in the given base" do
    ...
    "12345.to_s(16)".should be_equivalent_to "3039"
    "95.to_s(16)".should be_equivalent_to "5f"
    "12345.to_s(36)".should be_equivalent_to "9ix"
  end

  xit "raises an ArgumentError if the base is less than 2 or higher than 36" do
...
describe "Fixnum#to_s when no base given" do
  it "returns self converted to a String using base 10" do
    "255.to_s".should be_equivalent_to '255'
    "3.to_s".should be_equivalent_to '3'
    "0.to_s".should be_equivalent_to '0'
    "-9002.to_s".should be_equivalent_to '-9002'
  end
end
