...
xdescribe "Fixnum#[]" do
  ...
  xit "calls #to_int to coerce a String to a Bignum and returns 0" do
  ...
  xit "returns 0 when passed a Float in the range of a Bignum" do
