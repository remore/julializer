...
describe "Math.asin" do
  ...
  it "returns the arcsine of the argument" do
    "Math.asin(1)".should be_equivalent_to "Math::PI/2"
    "Math.asin(0)".should be_equivalent_to "0.0"
    "Math.asin(-1)".should be_equivalent_to "-Math::PI/2"
    "Math.asin(0.25)".should be_equivalent_to "0.252680255142079"
    "Math.asin(0.50)".should be_equivalent_to "0.523598775598299"
    "Math.asin(0.75)".should be_equivalent_to "0.8480620789814816"
  end
...
#  end
  ...
  it "returns NaN given NaN" do
    "Math.asin(Float::NAN).nan?".should be_equivalent_to "true"
  end
