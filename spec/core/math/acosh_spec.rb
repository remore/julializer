...
describe "Math.acosh" do
  ...
  it "returns the principle value of the inverse hyperbolic cosine of the argument" do
    "Math.acosh(14.2)".should be_equivalent_to "3.345146999647"
    "Math.acosh(1.0)".should be_equivalent_to "0.0"
  end
...
#  end
  ...
  it "returns NaN given NaN" do
    "Math.acosh(Float::NAN).nan?".should be_equivalent_to "true"
  end
