...
describe "Integer#lcm" do
  it "returns self if equal to the argument" do
    "1.lcm(1)".should be_equivalent_to "1"
    "398.lcm(398)".should be_equivalent_to "398"
  end
  ...
  it "returns the least common multiple of self and argument" do
    "200.lcm(2001)".should be_equivalent_to "400200"
    "99.lcm(90)".should be_equivalent_to "990"
  end

  it "returns a positive integer even if self is negative" do
    "-12.lcm(6)".should be_equivalent_to "12"
    "-100.lcm(100)".should be_equivalent_to "100"
  end
