...
describe "Integer#chr without argument" do
  ...
  it "returns a new String for each call" do
    "82.chr".should be_equivalent_to "R"
  end

  xit "raises a RangeError is self is less than 0" do
    lambda { -1.chr }.should raise_error(RangeError)
    lambda { -bignum_value.chr }.should raise_error(RangeError)
  end

  xdescribe "when Encoding.default_internal is nil" do
...
xdescribe "Integer#chr with an encoding argument" do
